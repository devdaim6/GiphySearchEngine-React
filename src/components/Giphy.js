      ...
      <main>
        <div className="container">
          ...
          <form role="search" className=" form-floating">
            ...
            />
            <label htmlFor="search" className="floatingInput">
              Search For Gifs
            </label>
          </form>
            ...
            {value.map((element) => {
              return (
                <div
                  ...
                  key={element.images.fixed_height.url}
                >
                  <GiphyItem images={element.images.fixed_height.url} />
                  <br />
                </div>
              );
            })}
      ...
      <footer className="text-center text-white">
        <span>
          ...
          <span>
            ...
            Copyright 2023 |
            <a
              style={{ textDecoration: "none", color: " #56e1ca " }}
              href="https://devdaim.me"
            >
              {" "}
              DevDaim
            </a>{" "}
